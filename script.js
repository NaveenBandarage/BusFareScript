...
const readline = require('readline').createInterface({
  ...
  readline.question('How much is on your ATHop? ', value => {
    ...
    console.log("The amount left over after single trip is: ", subtractSingleTrip(value));
    console.log("The amount after a day trip (back and forth is): ", subtractFullDay(value));
    readline.close();
  });
